...
<?php endif; ?>
        ...
        <div class="stats-grid" style="margin-bottom: var(--space-lg);">
            ...
            <div class="stat-card">
                <div class="stat-value"><?php echo isset($stats_estados['activo']) ? $stats_estados['activo'] : 0; ?>
                </div>
                <div class="stat-label">Activos</div>
            </div>
            <div class="stat-card">
                <div class="stat-value">
                    <?php echo isset($stats_estados['vitalicio']) ? $stats_estados['vitalicio'] : 0; ?></div>
                <div class="stat-label">Vitalicios</div>
            </div>
            <div class="stat-card">
                <div class="stat-value">
                    <?php echo isset($stats_estados['inactivo']) ? $stats_estados['inactivo'] : 0; ?></div>
        ...
        <div class="card" style="margin-bottom: var(--space-lg);">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                <div class="form-group">
                    ...
                    <input type="text" id="busqueda-tiempo-real" placeholder="DNI, apellidos o nombres..."
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
                                    <a href="carnet_socio.php?dni=<?php echo $socio['DNI']; ?>" class="btn btn-primary"
                                        style="padding: 0.5rem 1rem; font-size: 0.85rem;" title="Ver Carnet QR"
                                        target="_blank">
                                        🪪 Carnet
                                    </a>

                                    <a href="editar_socio.php?id=<?php echo $socio['ID']; ?>" class="btn btn-ghost"
                                        style="padding: 0.5rem 1rem; font-size: 0.85rem;" title="Editar">
                                        ✏️ Editar
                                    </a>
