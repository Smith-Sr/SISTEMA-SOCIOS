        ...
        <div class="card mb-lg">
            <div class="filters-grid">
                <div class="form-group">
                    ...
                    <input type="text" id="busqueda-tiempo-real" class="form-input"
                            ...
                            <td>
                                <div class="acciones-cell">
                                    ...
                                    <a href="carnet_socio.php?dni=<?php echo htmlspecialchars($socio['DNI']); ?>"
                                        class="btn-accion btn-accion-carnet" title="Ver Carnet QR" target="_blank">
                                        🪪 <span class="btn-accion-texto">Carnet</span>
                                    </a>

                                    <a href="editar_socio.php?id=<?php echo $socio['ID']; ?>"
                                        class="btn-accion btn-accion-editar" title="Editar socio">
                                        ✏️ <span class="btn-accion-texto">Editar</span>
                                    </a>

                                    <form method="POST" style="margin:0;"
                                        onsubmit="return confirmarEliminar('<?php echo htmlspecialchars($socio['DNI']); ?>', '<?php echo htmlspecialchars($socio['NOMBRES'] . ' ' . $socio['APELLIDOS']); ?>')">
                                        <input type="hidden" name="eliminar" value="<?php echo $socio['ID']; ?>">
                                        <button type="submit" class="btn-accion btn-accion-eliminar"
                                            title="Eliminar socio">
                                            🗑️ <span class="btn-accion-texto">Eliminar</span>
                                        </button>
                                    </form>
