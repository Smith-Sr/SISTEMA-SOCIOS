...
<head>
    ...
    * {
    ...
    .estado-suspendido {
        background: rgba(119, 54, 116, 0.15);
        color: #b86db4;
        border: 1px solid rgba(119, 54, 116, 0.3);
    }
...
<body>
    ...
    <div class="action-buttons">
        <a href="gestionar_socios.php" class="btn btn-back">
            ← Volver
        </a>
        <button onclick="window.print()" class="btn btn-print">
            🖨️ Imprimir Carnet
        </button>
<button onclick="compartirCarnet(event)" class="btn btn-share">
    📤 Compartir
</button>
    </div>
            ...
            <div class="carnet-body">
                ...
                <div>
                    <div class="qr-container">
                        <img src="../actions/generar_qr.php?dni=<?php echo $socio['DNI']; ?>" alt="QR del socio">
                    </div>
...
async function compartirCarnet(event) {
    ...
    try {
        ...
        const nombre = "<?php echo $socio['NOMBRES'] . ' ' . $socio['APELLIDOS']; ?>";
        const dni = "<?php echo $socio['DNI']; ?>";
        const estado = "<?php echo strtoupper($socio['ESTADO']); ?>";
        ...
        canvas.toBlob(async (blob) => {
            ...
            if (puedeCompartir) {
                // HTTPS móvil → compartir nativo con imagen
                ...
                // HTTP local o PC → descargar imagen
...
alert(`share: ${!!navigator.share} | canShare: ${!!navigator.canShare} | archivos: ${puedeCompartirArchivo}`);
